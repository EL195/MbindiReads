...
{{--     <div class="header">
     ...
     <div class="header">
          <h1>{{ trans('cruds.global.paswordchange') }}</h1>
    </div> 
        ...
        <div class="body">
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="email" id="email" name="email" class="{{ $errors->has('email') ? 'is-invalid' : '' }}" value="{{ old('email', auth()->user()->email) }}" required disabled>
                </div>
                @if($errors->has('email'))
