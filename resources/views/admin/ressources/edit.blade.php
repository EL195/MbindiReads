...
<div class="main-card">
    <div class="header">
        {{ trans('global.edit') }} {{ trans('cruds.global.ressource') }}
    </div>

    <form method="POST" action="{{ route("admin.ressources.update", [$ressource->id]) }}" enctype="multipart/form-data">
        @method('PUT')
        @csrf
        <div class="body">
        <div class="body">
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="text" id="name" name="name" class="{{ $errors->has('name') ? 'is-invalid' : '' }}" value="{{ old('name', $ressource->name) }}" required>
                </div>
                @if($errors->has('name'))
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="text" id="author" name="author" class="{{ $errors->has('author') ? 'is-invalid' : '' }}" value="{{ old('author', $ressource->author) }}" required>
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="number" id="pages_number" name="pages_number" class="{{ $errors->has('pages_number') ? 'is-invalid' : '' }}" value="{{ old('pages_number', $ressource->pages_number) }}" required>
                </div>
            ...
            <div class="mb-3">
                <label for="type" class="text-xs required">{{ trans('cruds.global.age') }} : {{ $ressource->agegroup->name }}</label>
                <div class="form-group">
