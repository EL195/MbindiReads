...
@can('folder_create')
    <div class="block my-4">
        <h1>
        {{ trans('cruds.menu.memberships') }}
        </h1>
    </div>

    <div class="block my-4" style="float: right;">
        <a class="btn-md btn-green items-end" href="{{ route('admin.memberships.create') }}">
            {{ trans('global.add') }} {{ trans('cruds.global.membership') }}
        </a>
    </div>
@endcan
<div class="main-card">
...
{{--                                 @can('folder_show')
                                ...
                                @can('folder_edit')
                                    <a class="btn-sm btn-blue" href="{{ route('admin.memberships.edit', $membership->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan
