...
<div class="main-card">
    <div class="header">
        {{ trans('global.create') }} {{ trans('cruds.global.answer') }}
    </div>
        ...
        <div class="body">
            <div class="mb-3" style="visibility:hidden;">
                ...
                <div class="form-group">
                    <input  type="number" id="quiz_id" name="quiz_id" class="{{ $errors->has('quiz_id') ? 'is-invalid' : '' }}" value="{{ old('quiz_id', $ressource_id) }}" >
                </div>
