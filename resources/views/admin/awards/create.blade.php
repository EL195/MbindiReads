...
<div class="main-card">
    <div class="header">
        {{ trans('global.create') }} {{ trans('cruds.global.award') }}
    </div>
    ...
    <form method="POST" action="{{ route("admin.awards.store") }}" enctype="multipart/form-data">
        ...
        <div class="body">
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="number" id="note" name="note" class="{{ $errors->has('name') ? 'is-invalid' : '' }}" value="{{ old('name') }}" required>
                </div>
                @if($errors->has('name'))
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="number" id="order" name="order" class="{{ $errors->has('name') ? 'is-invalid' : '' }}" value="{{ old('name') }}" required>
                </div>
                @if($errors->has('name'))
