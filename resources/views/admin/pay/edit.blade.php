...
<div class="main-card">
    <div class="header">
        {{ trans('global.edit') }} {{ trans('cruds.global.langue') }}
    </div>

    <form method="POST" action="{{ route("admin.langues.update", [$langue->id]) }}" enctype="multipart/form-data">
        @method('PUT')
        @csrf
        <div class="body">
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="text" id="title" name="title" class="{{ $errors->has('title') ? 'is-invalid' : '' }}" value="{{ old('title', $langue->title) }}" required>
                </div>
                @if($errors->has('name'))
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="text" id="code" name="code" class="{{ $errors->has('code') ? 'is-invalid' : '' }}" value="{{ old('code', $langue->code) }}" required>
                </div>
                @if($errors->has('code'))
