...
@can('folder_create')
    <div class="block my-4">
        <h1>
        {{ trans('cruds.menu.themes') }}
        </h1>
    </div>

    <div class="block my-4" style="float: right;">
        <a class="btn-md btn-green items-end" href="{{ route('admin.themes.create') }}">
            {{ trans('global.add') }} {{ trans('cruds.global.addGenre') }}
        </a>
    </div>
@endcan
<div class="main-card">
                ...
                <tbody>
                    @foreach($themes as $key => $theme)
                        <tr data-entry-id="{{ $theme->id }}">
                            ...
                            <td>
                                @foreach($theme->files as $key => $media)
...
{{--                                 @can('folder_show')
                                ...
                                @can('folder_edit')
                                    <a class="btn-sm btn-blue" href="{{ route('admin.themes.edit', $theme->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan
