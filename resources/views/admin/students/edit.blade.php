...
<div class="main-card">
    <div class="header">
        {{ trans('global.edit') }} {{ trans('cruds.global.student') }}
    </div>
        ...
        <div class="body">
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="text" id="last_name" name="last_name" class="{{ $errors->has('last_name') ? 'is-invalid' : '' }}" value="{{ $student->last_name }}" required>
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="text" id="first_name" name="first_name" class="{{ $errors->has('first_name') ? 'is-invalid' : '' }}" value="{{ $student->first_name }}" required>
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="text" id="username" name="username" class="{{ $errors->has('username') ? 'is-invalid' : '' }}" value="{{ $student->username }}" required>
                </div>
